...
import SocialTreeLink from "./SocialTreeLink";
import Header from './Header';

type SocialTreeProps = {
    data: User
}

export default function SocialTree({ data }: SocialTreeProps) {
    ...
    // Funcion que maneja el movimiento de las redes en el link de perfil.
                                ...
                                <div className='mt-20 flex flex-col gap-5'>
                                    ...
                                    >
                                        {enabledLinks.map(link => (
                                            <SocialTreeLink key={link.name} link={link} />
                                        ))}
                                    </SortableContext>
                                </div>
