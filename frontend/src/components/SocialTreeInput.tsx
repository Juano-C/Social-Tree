...
import { SocialTreeLink } from "../types"

type SocialTreeInputProps = {
    item: SocialTreeLink
    handleUrlChange: (e: React.ChangeEvent<HTMLInputElement>) => void
    handleEnableLinks: (socialNetwork: string) => void
}

export default function SocialTreeInput({ item, handleUrlChange, handleEnableLinks }: SocialTreeInputProps) {
    return (
